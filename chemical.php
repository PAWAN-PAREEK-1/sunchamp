...
<body>
   ...
   ?>
    ...
    <section class="products"  id="p1">
        ...
        <div class="points">
            <div class="point1">
               <a href="./chemicalPro.php#p1"><h4><img src="img/icon2.svg" alt="">PTA</h4></a>
               <a href="./chemicalPro.php#p2"> <h4><img src="img/icon2.svg" alt="">PP Chips</h4></a>

            </div>
            <div class="point1">
               <a href="./chemicalPro.php#p3"> <h4><img src="img/icon2.svg" alt="">HDPE Chips</h4></a>
               <a href="./chemicalPro.php#p4"> <h4><img src="img/icon2.svg" alt="">PVC</h4></a>
