  ...
  <body>
      ...
      <div class="pro-dec">
        ...
        <div class="mission mis">
          <p>
            ...
            sector for the manufacture of variety fabrics.
          </p>
          <p>
    ...
    <section class="products" id="p2">
      <div class="pro-dec">
        ...
        <div class="mission mis">
          <p>
            Raw cotton is loosened and cleaned; To remove straw and dry leaves.
            The cleaned cotton is fed into the machine. The cotton fiber is
